...
class Queue(models.Model):
    ...
    tracking_text_clicks = models.BooleanField(default=None)
    title = models.CharField(max_length=255, null=True, blank=True)
    authenticate = models.BooleanField(default=None)
    google_analytics = models.CharField(max_length=100, blank=True, null=True)
    auto_footer = models.BooleanField(default=None)
    generate_text = models.BooleanField(default=None)
    auto_tweet = models.BooleanField(default=None)
    segment_options = models.BooleanField(default=None)
    segment_options_all = models.BooleanField(default=None)
    ...
    locked = models.BooleanField(default=None)
